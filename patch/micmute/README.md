# Spurious mic-mute toggling — `huawei-wmi` EC storm filter

Mitigated in the driver. The underlying bug is in HONOR's EC firmware and
cannot be fixed from the OS.
